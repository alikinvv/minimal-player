...
$(document).ready(function(){
    ...
    tl.to('.player__albumImg', 3, {rotation: '360deg', repeat:-1, ease: Power0.easeNone}, '-=0.2');    
    tl.pause();
    ...
    $('.player__play').click(function() {
        ...
        if($('.player').hasClass('play')) {
            ...
            audioElement.pause();
            TweenMax.to('.player__albumImg', 0.2, {scale: 1,ease: Power0.easeNone})
            tl.pause();
        } else {
            $('.player').addClass('play');
            audioElement.play();
            TweenMax.to('.player__albumImg', 0.2, {scale: 1.1,ease: Power0.easeNone})
            tl.resume();            
        }
